...
export const directionGroups: DirectionGroup[] = directionGroupConfigs.map((group) => ({
  ...group,
...
export function HeroSection({ copy, basePath }: { copy: HomeCopy; basePath: string }) {
  return (
...
export function CoreValuesSection({ copy }: { copy: HomeCopy }) {
  return (
